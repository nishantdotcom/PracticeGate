...
function Question() {
  return (
    <div>
      <div className=" flex justify-between bg-gray-900      top-0 z-50    ">
        <div className="  flex justify-start gap-x-4 ">
          <div className="m-4">
            <SiLeetcode size={30} className="text-white" />
          </div>
          <div className=" flex m-4 gap-x-6 ">
            <div className="  hover:bg-slate-600  rounded-lg duration-0 hover:trasition hover:duration-1000   inline-block   ">
              <FaChevronLeft
                size={30}
