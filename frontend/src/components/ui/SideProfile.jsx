    ...
    <div className="text-white  rounded-lg shadow-inner  p-4 bg-gray-800">
      ...
      <div className=" mt-4">
        ...
        <div className=" flex justify-start gap-x-4 pt-4">
          <div>
            <div>
              <FaRegSquareCheck size={18} className=" text-blue-600" />
            </div>
          </div>
          <div className="flex justify-start gap-x-2">
        ...
        <div className=" flex justify-start gap-x-4 pt-4">
          <div>
            <div>
              <IoChatbubbles size={18} className=" text-green-600" />
            </div>
          </div>
          <div className="flex justify-start gap-x-2">
      ...
      <div className="mt-4   gap-y-4">
        <div className=" pt-2 flex gap-x-1">
          <div className="bg-slate-700   inline-block pl-2 pr-2 pt-1 pb-1 text-sm text-slate-400 rounded-xl">
            Computer Network
          </div>
        ...
        <div className=" pt-2  flex gap-x-1">
          <div className="bg-slate-700   inline-block pl-2 pr-2 pt-1 pb-1 text-sm r text-slate-400  rounded-xl">
            Digital Logic
          </div>
          <div className=" text-sm text-slate-400 pt-1">x12</div>
        </div>
